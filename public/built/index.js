	...
	function (msg, model) {
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				_p1,
				{lat: _p1.lat, lng: _p1.lng}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Main$position = _elm_lang$core$Native_Platform.incomingPort(
	'position',
	A2(
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A2(_user$project$Main$Model, 0.0, 0.0),
	_1: _elm_lang$core$Platform_Cmd$none
};
...
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$position(_user$project$Main$Change);
};
